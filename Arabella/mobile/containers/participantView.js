    ...
    return (
      <ImageBackground source={require('../assets/background.jpg')} style={{width: '100%', height: '100%'}}>
        <View style={{marginTop: 150}}>
          ...
          <View style={styles.button}>
            <Button onPress={() => {Actions.CalendarReadOnly({schoolID: this.props.userSchool.id})}} title="Kalendarz" />
          </View>
          <View style={styles.button}>
            <Button onPress={() => {Actions.UsersList({schoolID: this.props.userSchool.id, userRole: this.props.userRole})}} title="Lista Instruktorów" />
          </View>
          <View style={styles.button}>
